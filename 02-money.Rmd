...
```{r money, echo = FALSE, fig.cap='The Money Supply Has Grown Over Time', out.width='80%', fig.asp=.75, fig.align='center'}
jobs <- tq_get("M1", 
                 get = "economic.data",
                 from = Sys.Date() - lubridate::years(25))
jobs %>% ggplot(aes(date,price)) + 
  geom_line() + 
  labs(x = "Date", y = "Millions of Dollars", title = "M1 Money Supply: Deposits + Currency in Circulation", color = "Series") + 
  theme_bw()
```
...
```{r t10, echo=FALSE}
text_tbl <- data.frame(
  Col1 = c("Excess Reserves","Loan","","Required Reserves","Excess Reserves","Total"),
  Col2 = c(-20000,+20000,NA,+2000,+18000,+20000),
  Col3 = c("","","Deposits","","","Total"),
  Col4 = c(NA,NA,+20000,NA,NA,+20000)
)
...
knitr::kable(
  ...
  column_spec(1, bold = T) %>%
  column_spec(3, bold = T, border_left = T) %>%
  row_spec(6, bold = T, color = "black", background = "#B599CE") %>%
  add_header_above(c("Assets" = 2, "Liabilities + Net Worth" = 2))
...
text_tbl <- data.frame(
  ...
  Col2 = c(2105,28945,20000,20000,71050),
  Col3 = c("Deposits","","","Capital","Total"),
...
text_tbl <- data.frame(
  Col1 = c("","Required Reserves","Excess Reserves","Total"),
  Col2 = c(NA,-100,-900,-1000),
  Col3 = c("Deposits","","","Total"),
  Col4 = c(-1000,NA,NA,-1000)
)
...
text_tbl <- data.frame(
  Col1 = c("Required Reserves","Excess Reserves","Securities","Loans","Total"),
  Col2 = c(2005,28045,20000,20000,70050),
  Col3 = c("Deposits","","","Capital","Total"),
...
Let’s imagine that Jupiter makes a new \$30,000 loan to Emma who wants to start a cupcake shop. Emma plans to redeposit this loan in the bank, and like Olivia is also willing to pay an 8\% interest rate on this loan. At the moment the loan is made, the bank does not have enough in excess reserves (since \$28,045 < \$30,000) and making the loan would leave them with only a portion of the reserves they are required to have. However, because Emma redeposits the money at Jupiter, there is no shortfall in required reserves. You should notice that in this situation, the total amount of reserves between Table \@ref(tab:t13) and \@ref(tab:t15) is unchanged. It is only the portion that is considered to be required that has changed. In the next section, we discuss what happens if Emma were to write a large check using the newly created deposits just placed in her account.


```{r t14, echo=FALSE}
text_tbl <- data.frame(
  Col1 = c("Excess Reserves","Loan","","Required Reserves","Excess Reserves","Total"),
  Col2 = c(-30000,+30000,NA,+3000,+27000,+30000),
  Col3 = c("","","Deposits","","","Total"),
  Col4 = c(NA,NA,+30000,NA,NA,+30000)
)
...
text_tbl <- data.frame(
  Col1 = c("Required Reserves","Excess Reserves","Securities","Loans","Total"),
  Col2 = c(5005,25045,20000,50000,100050),
  Col3 = c("Deposits","","","Capital","Total"),
  Col4 = c(50050,NA,NA,50000,100050)
)
...
text_tbl <- data.frame(
  Col1 = c("","Required Reserves","Excess Reserves","Total"),
  Col2 = c(NA,-3000,-27000,-30000),
  Col3 = c("Deposits","","","Total"),
  Col4 = c(-30000,NA,NA,-30000)
)
...
text_tbl <- data.frame(
  Col1 = c("Required Reserves","Excess Reserves","Securities","Loans","Total"),
  Col2 = c(2005,-1995,20000,50000,70050),
  Col3 = c("Deposits","","","Capital","Total"),
  Col4 = c(20050,NA,NA,50000,70050)
)
...
text_tbl <- data.frame(
  Col1 = c("Required Reserves","Excess Reserves","Securities","Loans","Total"),
  Col2 = c(2005,0,20000,50000,72005),
  Col3 = c("Deposits","Interbank Loan","","Capital","Total"),
  Col4 = c(20050,1955,NA,50000,72005)
)
...
text_tbl <- data.frame(
  Col1 = c("Required Reserves","Excess Reserves","Securities","Loans","Total"),
  Col2 = c(2005,10000,10000,50000,72005),
  Col3 = c("Deposits","Interbank Loan","","Capital","Total"),
  Col4 = c(20050,1955,NA,50000,72005)
)
...
text_tbl <- data.frame(
  Col1 = c("Required Reserves","Excess Reserves","Securities","Loans","Total"),
  Col2 = c(12005,0,10000,150000,172005),
  Col3 = c("Deposits","Interbank Loan","","Capital","Total"),
...
text_tbl <- data.frame(
  Col1 = c("Required Reserves","Excess Reserves","Securities","Loans","Total"),
  Col2 = c(12005,0,10000,140000,162005),
  Col3 = c("Deposits","Interbank Loan","","Capital","Total"),
...
text_tbl <- data.frame(
  Col1 = c("Required Reserves","Excess Reserves","Securities","Loans","Total"),
  Col2 = c(12005,0,10000,95000,117005),
  Col3 = c("Deposits","Interbank Loan","","Capital","Total"),
...
text_tbl <- data.frame(
  Col1 = c("Required Reserves","Excess Reserves","Securities","Loans","Total"),
  Col2 = c(30000,0,75000,220000,325000),
  Col3 = c("Deposits","Interbank Loan","","Capital","Total"),
...
text_tbl <- data.frame(
  Col1 = c("Required Reserves","Excess Reserves","Securities","Loans","Total"),
  Col2 = c(23000,7000,75000,150000,255000),
  Col3 = c("Deposits","Interbank Loan","","Capital","Total"),
...
*	**Money Supply**: The Fed could try to target the total supply of money, in the form of deposits and currency (i.e., M1) or the broader M2 money supply (M1+MMMF+Savings+Time deposits).[^12] 
...
text_tbl <- data.frame(
  Col1 = c("Required Reserves","Excess Reserves","Securities","Loans","Total"),
  Col2 = c(20000,0,75000,130000,225000),
  Col3 = c("Deposits","Interbank Loan","","Capital","Total"),
  Col4 = c(200000,10000,NA,15000,225000)
)
...
knitr::kable(
  text_tbl, "html", caption = "**Callisto Bank: Balance Sheet with Savings Accounts**", booktabs = TRUE, col.names = c("","","",""),
  format.args = list(big.mark = ",", scientific = FALSE)
  ) %>%
  kable_styling(full_width = F) %>%
  column_spec(1, bold = T) %>%
...
text_tbl <- data.frame(
  Col1 = c("","","Required Reserves","Excess Reserves","Total"),
  Col2 = c(NA,NA,-5000,+5000,+0),
  Col3 = c("Deposits","Savings","","","Total"),
  Col4 = c(-50000,+50000,NA,NA,+0)
)

text_tbl <- dplyr::mutate_if(text_tbl, is.numeric, format_dol_fun)

knitr::kable(
  text_tbl, "html", caption = "**Callisto Bank: T-Account Due to Sweeps**", booktabs = TRUE, col.names = c("","","",""),
  format.args = list(big.mark = ",", scientific = FALSE)
  ) %>%
  kable_styling(full_width = F) %>%
  column_spec(1, bold = T) %>%
...
text_tbl <- data.frame(
  Col1 = c("Required Reserves","Excess Reserves","Securities","Loans","Total"),
  Col2 = c(15000,5000,75000,130000,225000),
  Col3 = c("Deposits","Interbank Loan","","Capital","Total"),
  Col4 = c(150000,60000,NA,15000,225000)
)

text_tbl <- dplyr::mutate_if(text_tbl, is.numeric, format_dol_fun)

knitr::kable(
  text_tbl, "html", caption = "**Callisto Bank: Balance Sheet After Sweeps**", booktabs = TRUE, col.names = c("","","",""),
  format.args = list(big.mark = ",", scientific = FALSE)
  ) %>%
  kable_styling(full_width = F) %>%
  column_spec(1, bold = T) %>%
...
The size of the balance sheet does not change, and total reserves do not change, just how their money is categorized. The loan gets created in Table \@ref(tab:t34), and the final balance sheet is shown below in Table \@ref(tab:t35).

```{r t34, echo=FALSE}
text_tbl <- data.frame(
  Col1 = c("Excess Reserves","Loans","","Required Reserves","Excess Reserves","Total"),
  Col2 = c(-5000,+5000,NA,+500,+4500,+5000),
  Col3 = c("","","Deposits","","","Total"),
  Col4 = c(NA,NA,+5000,NA,NA,+0)
)

text_tbl <- dplyr::mutate_if(text_tbl, is.numeric, format_dol_fun)

knitr::kable(
  text_tbl, "html", caption = "**Callisto Bank: T-Account Due to New $5,000 Loan and Redeposit**", booktabs = TRUE, col.names = c("","","",""),
  format.args = list(big.mark = ",", scientific = FALSE)
  ) %>%
  kable_styling(full_width = F) %>%
  column_spec(1, bold = T) %>%
...
text_tbl <- data.frame(
  Col1 = c("Required Reserves","Excess Reserves","Securities","Loans","Total"),
  Col2 = c(15500,4500,75000,135000,230000),
  Col3 = c("Deposits","Interbank Loan","","Capital","Total"),
  Col4 = c(155000,60000,NA,15000,230000)
)

text_tbl <- dplyr::mutate_if(text_tbl, is.numeric, format_dol_fun)

knitr::kable(
  text_tbl, "html", caption = "**Callisto Bank: Balance Sheet After $5,000 Loan and Redeposit**", booktabs = TRUE, col.names = c("","","",""),
  format.args = list(big.mark = ",", scientific = FALSE)
  ) %>%
  kable_styling(full_width = F) %>%
  column_spec(1, bold = T) %>%
...
[^7]: The Federal Reserve (Fed) pays banks interest on reserves. The Fed creates reserves—out of thin air—to pay to private banks for their reserve balances. 

[^8]: The FOMC can decide to change rates in between meetings, but this is rare and usually only in response to very severe shocks. The last time the FOMC changed interest rates in between meetings was in early 2008.

[^9]: Notice that the Fed is effectively using newly created money to bid up the price of bonds that are for sale on the open market. This would lead to an increase in the price, and a decline in the interest rate. In our example here, this is what the Fed is trying to accomplish. When interest rates are rising away from the Fed’s target federal funds rate, they inject liquidity to ease the upward pressure. If interest rates are falling below their target, their goal is to extract liquidity, lowering prices and raising interest rates.

[^10]: We are assuming here that the debt issued by the bank only takes the form of loans, and equity only comes in the form of capital.

[^11]: Note again, we are assuming all loans created are immediately held as deposits.

[^12]: Savings accounts or money-market deposit accounts (MMDA) are less liquid than checking. Money market mutual funds (MMMF) are another less-liquid alternative to deposits. Finally, small-denominated time deposits-or certificate of deposit (CDs)-are investments that can be liquidated with a small penalty.